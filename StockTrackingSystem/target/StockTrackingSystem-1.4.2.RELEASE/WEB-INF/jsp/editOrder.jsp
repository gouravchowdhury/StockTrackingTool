  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/pendingOrder">Back</a></li>
      </ol>
    </section>
            ...
            <form role="form">
              <div class="box-body col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerReceived">
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerDelivered">
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="exampleInputPassword1">Delivered Box Count:</label>
              ...
              <div class="box-body col-md-6">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Delivered Challan No.:</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Received Challan No.">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Cheque Number">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">TDS 1% Amount:</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="TDS 1% Amount">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Quality Discount:</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Quality Discount">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Company 5% GST Add Amount:</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Company 5% GST Add Amount">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Total Bill Amount:</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Total Bill Amount">
                </div>
...
<script>
  $(function () {
    ...
    //Date picker
    $('#datepickerReceived').datepicker({
      autoclose: true
    })
    
     $('#datepickerDelivered').datepicker({
      autoclose: true
    })
